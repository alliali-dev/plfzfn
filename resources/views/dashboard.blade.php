                        ...
                        <div class="header-top d-sm-flex align-items-center">
                            ...
                            <div class="center-content">
                                <p class="d-sm-flex align-items-center">
                                    <span class="font-primary m-r-10 f-w-700">$859.25k</span>
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="code-box-copy">
                            <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#yearly-overview"
                                title="Copy"><i class="icofont icofont-copy-alt"></i>
                            </button>
                            <pre>
                            <code class="language-html" id="yearly-overview">
                                <div class="card income-card"> 
                                    <div class="card-header">
                                        <div class="header-top d-sm-flex align-items-center">
                                            ...
                                            <div class="center-content" >
                                                ...
                                                <i class="toprightarrow-primary fa fa-arrow-up m-l-10 m-r-10" > </i> 86% More than last year
                                                 </p> 
                                            </div>
                                            <div class="setting-list">
                                                <ul class="list-unstyled setting-option">
                                    ...
                                    <div class="card-body p-0">div id="chart-timeline-dashbord"></div>
                                </div>
                            </code>
                        </pre>
                        </div>
                                                ...
                                                <td>
                                                    <div class="media"><img class="img-fluid rounded-circle"
                                                        ...
                                                        <div class="media-body"><a
                                                                href="product-page.html"><span>Beautiful Golden Tree
                                                                    plant</span></a></div>
                                                    </div>
                                                </td>
                                                <td>
